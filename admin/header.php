...
<a class="navbar-brand mt-5" href="javascript:void(0)"><span style="color: #e7663f">Ced</span><span  style="color: #585CA7">Hosting</span></a>
</a>
</div>
...
<li class="nav-item">
<a class="nav-link" href="Addproducts.php" target="_blank">
<i class="ni ni-palette"></i>
<span class="nav-link-text">Add products</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="ViewProducts.php" target="_blank">
<i class="ni ni-ui-04"></i>
<span class="nav-link-text">View Products</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="Newoffers.php" target="_blank">
...
<ul class="navbar-nav mb-md-3">
<li class="nav-item">
<a class="nav-link" href="PendingOrders.php" target="_blank">
<i class="ni ni-spaceship"></i>
<span class="nav-link-text">Pending Orders</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="CompletedOrders.php" target="_blank">
<i class="ni ni-palette"></i>
<span class="nav-link-text">Completed Orders</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="CancelledOrders.php" target="_blank">
<i class="ni ni-ui-04"></i>
<span class="nav-link-text">Cancelled Orders</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="GenerateInvoice.php" target="_blank">
<i class="ni ni-chart-pie-35"></i>
...
<ul class="navbar-nav mb-md-3">
<li class="nav-item">
<a class="nav-link" href="Activeservices.php" target="_blank">
<i class="ni ni-spaceship"></i>
<span class="nav-link-text">Active Services</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="Expired.php" target="_blank">
<i class="ni ni-palette"></i>
...
<ul class="navbar-nav mb-md-3">
<li class="nav-item">
<a class="nav-link" href="Allusers.php" target="_blank">
<i class="ni ni-spaceship"></i>
<span class="nav-link-text">All Users</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="newuser.php" target="_blank">
<i class="ni ni-palette"></i>
...
<ul class="navbar-nav mb-md-3">
<li class="nav-item">
<a class="nav-link" href="NewBlog.php" target="_blank">
<i class="ni ni-spaceship"></i>
<span class="nav-link-text">Add New Blog</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="allblog.php" target="_blank">
<i class="ni ni-palette"></i>
...
<li class="nav-item">
<a class="nav-link" href="securityquestion.php" target="_blank">
<i class="ni ni-palette"></i>
<span class="nav-link-text">Change Security Question</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="changepassword.php" target="_blank">
<i class="ni ni-palette"></i>
